oS.Init({
    PName: [oFlowerPot,oThreepeater, oCherryBomb,oTenManNute, oJalapeno,oSquash, oGatlingPea, oSnowRepeater,oPumpkinHead, oChomper, oRepeater],
    ZName: [oZombie, oZombie2, oZombie3, oConeheadZombie, oPoleVaultingZombie,oWJY, oJackinTheBoxZombie,oBucketheadZombie,oMustacheZombie],
...
{
    AZ: [[oZombie, 1, 1],[oWJY, 1, 1],[oJackinTheBoxZombie, 1, 1], [oZombie2, 1, 3], [oZombie3, 1, 6], [oConeheadZombie, 5, 10], [oPoleVaultingZombie, 2, 1], [oBucketheadZombie, 5, 1]],
    FlagNum: 30,
    FlagToSumNum: {
