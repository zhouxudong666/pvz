...
oS.Init({
   ...
   CustomSpecial(oshitou0, parseInt(Math.random()*5)+1, parseInt(Math.random()*6)+4)
  CustomSpecial(oshitou1, parseInt(Math.random()*5)+1, parseInt(Math.random()*6)+4)
	CustomSpecial(oshitou2, parseInt(Math.random()*5)+1, parseInt(Math.random()*6)+4)
   CustomSpecial(oshitou3, parseInt(Math.random()*5)+1, parseInt(Math.random()*6)+4)
        
        CustomSpecial(oshitou, parseInt(Math.random()*5)+1, parseInt(Math.random()*6)+4)
       
    },
    LF: [0, 1, 1,1, 1,1],
    LevelName: "远古教堂(落石部分)--第2夜",
    LvlEName: 0,
    DKind: 0,
